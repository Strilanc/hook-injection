...
from hookinj.gen._util import stim_circuit_with_transformed_coords
from hookinj.gen._flow import Flow, PauliString
...
class Chunk:
    ...
    def verify(self):
        ...
        from hookinj.gen._flow_verifier import FlowStabilizerVerifier
    ...
    def magic_init_chunk(self) -> 'Chunk':
        ...
        """
        from hookinj.gen._flow_util import magic_init_for_chunk
    ...
    def magic_end_chunk(self) -> 'Chunk':
        ...
        no care for connectivity or physical limitations of hardware.
        """
        from hookinj.gen._flow_util import magic_measure_for_chunk
